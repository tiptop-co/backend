...
![p3express-диаграмма](./docs/img/p3express.png)

### Этап А. Запуск проекта
| Код | Название задачи |
| --- | --- |
| A1  | Начало проекта (02.03.26) |
| A2  | Описание проекта TipTop   |
| A3  | Согласование ТЗ |
| A4  | Подготовка репозиториев и CI/CD |
| A5  | Настройка системы управления проектом (Github Project) |
| A6  | Создание диграмм (ER, схемы таблиц) |
| A7  | Подготовка инфраструктуры для проекта |

### Этап B. Планирование цикла

| Код | Название задачи |
| --- | --- |
| B1  | Актуализировать планы и задачи в github issues |
| B2  | Принять решение о продолжении цикла   |
| B3  | Провести груминг бэклога |

### Этап С. Eженедельные действия

| Код | Название задачи |
| --- | --- |
| C1  | Оценить прогресс по задачам (github issues) |
| C2  | Провести weekly sync (синхрозизация и корректировка задач) |

### Этап D. Ежедневные действия

| Код | Название задачи |
| --- | --- |
| D1  | Фиксировать RICs (RICs = Risks, Issues, Change requests) |
| D2  | Реагировать на проблемы (критические - в чат, остальные - в бэклог) |

### Этап E. Закрытие цикла

| Код | Название задачи |
| --- | --- |
| E1  | Провести ретроспективу, запланировать улучшения  |
| E2  | Зафиксировать итоги цикла |

### Этап F. Завершение проекта

| Код | Название задачи |
| --- | --- |
| F1  | Проверить выполнение требований ТЗ |
| F2  | Завершить подготовку документации |
| F3  | Получение обратной связи |

### Этап G. После проекта

| Код | Название задачи |
| --- | --- |
| G1  | Обсуждение дополнительных функций и исправлений |
| G2  | Доработка функций при необходимости |
